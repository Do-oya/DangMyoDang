...
import com.example.api_test.abandom.Abandom
import com.example.api_test.abandom.RetrofitObject_abandom
import com.example.api_test.shelter.RetrofitObject_shelter
import com.example.api_test.shelter.Shelter
import com.example.api_test.sido.AdaptionList
import com.example.api_test.sido.RetrofitObject
import com.example.api_test.sido.Sido
import com.example.api_test.sigungu.RetrofitObject_sigungu
import com.example.api_test.sigungu.Sigungu
                                                                                            ...
                                                                                            spinner3.onItemSelectedListener =
                                                                                                object :
                                                                                                    ...
                                                                                                    private fun setAbandomData(abandomResponse: Abandom?) {
                                                                                                        // 데이터가 없거나 비어있을 경우 처리
                                                                                                        val combinedDataList = mutableListOf<com.example.api_test.AdaptionList>()
                                                                                                        if (abandomResponse == null || abandomResponse?.response?.body?.items?.item.isNullOrEmpty()) {
                                                                                                            ...
                                                                                                            val processedDataList = abandomResponse.response.body.items.item.map {
                                                                                                                com.example.api_test.AdaptionList(it.happenPlace ?: "", it.age ?: "",it.careAddr , it.specialMark, it.weight, it.kindCd, it.popfile ?: "")
                                                                                                            }
