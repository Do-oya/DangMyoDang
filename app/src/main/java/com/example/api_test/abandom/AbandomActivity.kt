...
class AbandomActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_abandom)
    ...
    private fun getAdaption() {
        ...
        RetrofitObject_abandom.getApiService_abandom().getInfo("20230101", "20231101", "417000", "000072","6110000", "3220000", "Y", "1", "10", "json").enqueue(object :
            Callback<Abandom> {
            override fun onResponse(call: Call<Abandom>, response: Response<Abandom>) {
                setResponseText(response.code(), response.body())
                Toast.makeText(applicationContext, "success", Toast.LENGTH_SHORT).show()
            }

            override fun onFailure(call: Call<Abandom>, t: Throwable) {
    ...
    private fun setResponseText(resCode: Int, body: Abandom?) {
        // 상태별 text 설정
